...
namespace UnityEditor.Rendering.Toon
{
    internal partial class UTS3GUI : UnityEditor.ShaderGUI
    {
        ...
        // ieishi
        protected MaterialProperty blendTex = null;
        protected MaterialProperty blendMap = null;
        ...
        void FindProperties(MaterialProperty[] props)
        {
            ...
            // ieishi
            blendTex = FindProperty("_BlendTex", props);
            blendMap = FindProperty("_BlendMap", props);
